...
conn = sqlite3.connect('Desktop/py/py16/gmane/index.sqlite')
cur = conn.cursor()
...
conn_1 = sqlite3.connect('Desktop/py/py16/gmane/mapping.sqlite')
cur_1 = conn_1.cursor()
...
conn_1 = sqlite3.connect('file:Desktop/py/py16/gmane/content.sqlite?mode=ro', uri=True)
cur_1 = conn_1.cursor()
